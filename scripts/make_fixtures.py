...
VALUES = {
    ...
    "회차": "5회차",
    "교육 대상·인원": "32명, 주무관·데이터 담당자",
    "교육 목표": "부서 데이터를 AI 로 직접 다뤄 민원·보고 업무에 바로 쓰게 한다",
    "교육 구성": "사전 온라인 2일 → 집합수업 3일 → 결과 발표",
    "교육 내용": "챗GPT 로 민원 답변 초안 쓰기\n엑셀 데이터 정리\n부서 데이터로 대시보드 만들기",
    "실습 결과물": "민원 분류 대시보드 프로토타입 6개",
    "이 과정의 주요 포인트": "부서별 실제 민원 데이터로 실습했습니다.\n32명 중 29명이 인증에 합격했습니다.",
    "(운영자 관점) 현장에서 인상 깊었던 내용": "발표 때 각 부서가 자기 민원 데이터를 띄워 놓고 설명해 다른 부서에서 질문이 이어졌다",
